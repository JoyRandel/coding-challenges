puts "Hello, What is your birthdate? Please give the answer in the format MMDDYYYY."
birthdate = gets
...
def get_message(birth_path_number)
  ...
  when 4 
    message = "Your numerology number is #{birth-path_number}.\nThis is the worker. Practical, with a love of detail, Fours are trustworthy, hard-working, and helpful. Ruled by Uranus."
  when 5 
  ...
  when 9 
    ...
    message = "Did you put your birthdate in the MMDDYYYY format? Can you try again?"
  end
end
